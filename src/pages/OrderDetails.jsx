...
const extractCustomerInfo = (orderData) => {
  ...
  // Debug: Log the order data structure to console
  console.log('Extracting customer info from:', data)
...
const OrderDetails = ({ sellerId = null, orderPath = null }) => {
  ...
  const processOrderData = (orderData, id, path) => {
    ...
    // Debug: Log the extracted customer info
    console.log('Extracted customer info:', customer)
        ...
        <div className="bg-gray-800 rounded-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto border border-gray-700 shadow-2xl">
          ...
          <div className="p-6 border-t border-gray-700 flex justify-between">
            <div className="flex space-x-2">
              ...
              <button 
                onClick={() => {
                  console.log('Order FULL data for debugging:', order)
    ...
    <div className="p-6 bg-gray-900 min-h-screen font-sans">
      <div className="mb-8 border-b border-gray-800 pb-4">
        <div className="flex justify-between items-center">
          ...
          <button 
            onClick={() => {
              console.log('DEBUG: All orders data:', orders)
              console.log('DEBUG: First order details:', orders[0])
              alert('Check console for data structure (F12 -> Console)')
            }}
            className="flex items-center text-sm bg-gray-700 hover:bg-gray-600 px-3 py-2 rounded-lg text-yellow-400"
          >
            <AlertCircle className="w-4 h-4 mr-2" />
